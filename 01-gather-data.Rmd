...
# meta[, epirr_id_wo_version := tstrsplit(EpiRR, '.', fixed = TRUE)[1]]
# all_files[uuid %in% wgbs_samples[epirr_id_wo_version %in% meta[epirr_id_wo_version %in% wgbs_samples[, epirr_id_wo_version] & harmonized_sample_ontology_intermediate == 'monocyte' & harmonized_sample_disease_intermediate == 'None', epirr_id_wo_version], uuid]]

# determine_files_to_write(all_files[uuid %in% wgbs_samples[epirr_id_wo_version %in% meta[epirr_id_wo_version %in% wgbs_samples[, epirr_id_wo_version] & harmonized_sample_ontology_intermediate == 'monocyte' & harmonized_sample_disease_intermediate == 'None', epirr_id_wo_version], uuid] & endsWith(filename, 'cpg.bed.gz')], prefix = 'alex_wgbs', dir_to_write = wgbs_data_dir, n_chunks = 4)
