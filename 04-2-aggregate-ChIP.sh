...
bigWigAverageOverBed ${my_array[${SLURM_ARRAY_TASK_ID}]} processed_data/aggregateOver.bed sample_dts/$(basename ${my_array[${SLURM_ARRAY_TASK_ID}]}).tab -minMax && gzip -f sample_dts/$(basename ${my_array[${SLURM_ARRAY_TASK_ID}]}).tab
