...
```{r}
rna_metadata <- fread('/nfs/data/IHEC/RNAseq/ihec_metadata_rna.csv')
...
isoform_files <- list.files('/nfs/data/IHEC/RNAseq/RNA-Seq', pattern = '\\.isoforms\\.results$', full.names = T)
