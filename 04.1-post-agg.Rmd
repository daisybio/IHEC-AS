...
cols_to_add <- c('gene_id', 'distance_TSS', 'distance_TES', 'width;upstream_other_region', 'width;event_name', 'width;downstream_other_region', 'Event Type', '3ss', '5ss')
...
dennis_cor <- aggregated_dt[, lapply(.SD, function(x){ 
